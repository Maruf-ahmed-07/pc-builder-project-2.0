...
const Profile = () => {
  ...
  // Fetch user profile to update form data
  useQuery({
              ...
              <div className="builds-tab">
                ...
                {userBuilds?.length === 0 ? (
                  ...
                  <div className="builds-grid">
                    {userBuilds?.slice(0, 6).map(build => (
                      <div key={build._id} className="build-card">
                        ...
                        <div className="build-info">
                          ...
                          <div className="build-stat">
                            ...
                            <span className="value">{Object.keys(build.components || {}).length}</span>
                          </div>
                          <div className="build-stat">
                        ...
                        <div className="build-components">
                          ...
                          <div className="components-preview">
                            {Object.entries(build.components || {}).slice(0, 3).map(([category, component]) => (
                              <div key={category} className="component-preview">
                            ...
                            {Object.keys(build.components || {}).length > 3 && (
                              <div className="more-components">
                                +{Object.keys(build.components || {}).length - 3} more
                              </div>
                            )}
                          </div>
                        </div>
                    ...
                    {userBuilds?.length > 6 && (
                      <div className="view-all-builds">
                        <button 
                          onClick={() => navigate('/my-builds')}
                          className="btn btn-outline-primary"
                        >
                          View All {userBuilds.length} Builds
                        </button>
                      </div>
                    )}
                  </div>
