...
export const ChatProvider = ({ children }) => {
	...
	const value = { messages, setMessages, sendMessage, connected, threads, reloadThreads: loadAdminThreads, presence, loadUserThread, markReadUser, markReadAdmin, typing, emitTyping, socket: socketRef.current };
